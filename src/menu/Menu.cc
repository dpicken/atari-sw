...
void printActionLine(bool hasParentMenu, const menu::Menu::action_type& action0, const menu::Menu::action_type& action1) {
...
void menu::Menu::render() const {
  ...
  printBlankLine();
  printBlankLine();
  printActionLine(hasParentMenu(), m_action0, m_action1);
